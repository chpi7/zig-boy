...
pub fn decode_instruction(opcode: u8) Instruction {
    const result = switch (opcode) {
        ...
        0x20 => Instruction{ .opcode = 0x20, .op = OpType.JR, .operands = .{ Operand{ .t=OperandType.imm8, .relative = false }, Operand{ .t=OperandType.unused, .relative = false }, Operand{ .t=OperandType.unused, .relative = false } }, .num_operands = 1, .bytes = 2 },
        ...
        0x28 => Instruction{ .opcode = 0x28, .op = OpType.JR, .operands = .{ Operand{ .t=OperandType.imm8, .relative = false }, Operand{ .t=OperandType.unused, .relative = false }, Operand{ .t=OperandType.unused, .relative = false } }, .num_operands = 1, .bytes = 2 },
        ...
        0x30 => Instruction{ .opcode = 0x30, .op = OpType.JR, .operands = .{ Operand{ .t=OperandType.imm8, .relative = false }, Operand{ .t=OperandType.unused, .relative = false }, Operand{ .t=OperandType.unused, .relative = false } }, .num_operands = 1, .bytes = 2 },
        ...
        0x38 => Instruction{ .opcode = 0x38, .op = OpType.JR, .operands = .{ Operand{ .t=OperandType.reg8, .relative = false, .register = Register.C }, Operand{ .t=OperandType.imm8, .relative = false }, Operand{ .t=OperandType.unused, .relative = false } }, .num_operands = 2, .bytes = 2 },
        ...
        0xc0 => Instruction{ .opcode = 0xc0, .op = OpType.RET, .operands = .{ Operand{ .t=OperandType.unused, .relative = false }, Operand{ .t=OperandType.unused, .relative = false }, Operand{ .t=OperandType.unused, .relative = false } }, .num_operands = 0, .bytes = 1 },
        ...
        0xc2 => Instruction{ .opcode = 0xc2, .op = OpType.JP, .operands = .{ Operand{ .t=OperandType.imm16, .relative = false }, Operand{ .t=OperandType.unused, .relative = false }, Operand{ .t=OperandType.unused, .relative = false } }, .num_operands = 1, .bytes = 3 },
        ...
        0xc4 => Instruction{ .opcode = 0xc4, .op = OpType.CALL, .operands = .{ Operand{ .t=OperandType.imm16, .relative = false }, Operand{ .t=OperandType.unused, .relative = false }, Operand{ .t=OperandType.unused, .relative = false } }, .num_operands = 1, .bytes = 3 },
        ...
        0xc7 => Instruction{ .opcode = 0xc7, .op = OpType.RST, .operands = .{ Operand{ .t=OperandType.vec, .relative = false }, Operand{ .t=OperandType.unused, .relative = false }, Operand{ .t=OperandType.unused, .relative = false } }, .num_operands = 1, .bytes = 1 },
        0xc8 => Instruction{ .opcode = 0xc8, .op = OpType.RET, .operands = .{ Operand{ .t=OperandType.unused, .relative = false }, Operand{ .t=OperandType.unused, .relative = false }, Operand{ .t=OperandType.unused, .relative = false } }, .num_operands = 0, .bytes = 1 },
        ...
        0xca => Instruction{ .opcode = 0xca, .op = OpType.JP, .operands = .{ Operand{ .t=OperandType.imm16, .relative = false }, Operand{ .t=OperandType.unused, .relative = false }, Operand{ .t=OperandType.unused, .relative = false } }, .num_operands = 1, .bytes = 3 },
        ...
        0xcc => Instruction{ .opcode = 0xcc, .op = OpType.CALL, .operands = .{ Operand{ .t=OperandType.imm16, .relative = false }, Operand{ .t=OperandType.unused, .relative = false }, Operand{ .t=OperandType.unused, .relative = false } }, .num_operands = 1, .bytes = 3 },
        ...
        0xcf => Instruction{ .opcode = 0xcf, .op = OpType.RST, .operands = .{ Operand{ .t=OperandType.vec, .relative = false }, Operand{ .t=OperandType.unused, .relative = false }, Operand{ .t=OperandType.unused, .relative = false } }, .num_operands = 1, .bytes = 1 },
        0xd0 => Instruction{ .opcode = 0xd0, .op = OpType.RET, .operands = .{ Operand{ .t=OperandType.unused, .relative = false }, Operand{ .t=OperandType.unused, .relative = false }, Operand{ .t=OperandType.unused, .relative = false } }, .num_operands = 0, .bytes = 1 },
        ...
        0xd2 => Instruction{ .opcode = 0xd2, .op = OpType.JP, .operands = .{ Operand{ .t=OperandType.imm16, .relative = false }, Operand{ .t=OperandType.unused, .relative = false }, Operand{ .t=OperandType.unused, .relative = false } }, .num_operands = 1, .bytes = 3 },
        ...
        0xd4 => Instruction{ .opcode = 0xd4, .op = OpType.CALL, .operands = .{ Operand{ .t=OperandType.imm16, .relative = false }, Operand{ .t=OperandType.unused, .relative = false }, Operand{ .t=OperandType.unused, .relative = false } }, .num_operands = 1, .bytes = 3 },
        ...
        0xd7 => Instruction{ .opcode = 0xd7, .op = OpType.RST, .operands = .{ Operand{ .t=OperandType.vec, .relative = false }, Operand{ .t=OperandType.unused, .relative = false }, Operand{ .t=OperandType.unused, .relative = false } }, .num_operands = 1, .bytes = 1 },
        ...
        0xdf => Instruction{ .opcode = 0xdf, .op = OpType.RST, .operands = .{ Operand{ .t=OperandType.vec, .relative = false }, Operand{ .t=OperandType.unused, .relative = false }, Operand{ .t=OperandType.unused, .relative = false } }, .num_operands = 1, .bytes = 1 },
        ...
        0xe7 => Instruction{ .opcode = 0xe7, .op = OpType.RST, .operands = .{ Operand{ .t=OperandType.vec, .relative = false }, Operand{ .t=OperandType.unused, .relative = false }, Operand{ .t=OperandType.unused, .relative = false } }, .num_operands = 1, .bytes = 1 },
        ...
        0xef => Instruction{ .opcode = 0xef, .op = OpType.RST, .operands = .{ Operand{ .t=OperandType.vec, .relative = false }, Operand{ .t=OperandType.unused, .relative = false }, Operand{ .t=OperandType.unused, .relative = false } }, .num_operands = 1, .bytes = 1 },
        ...
        0xf7 => Instruction{ .opcode = 0xf7, .op = OpType.RST, .operands = .{ Operand{ .t=OperandType.vec, .relative = false }, Operand{ .t=OperandType.unused, .relative = false }, Operand{ .t=OperandType.unused, .relative = false } }, .num_operands = 1, .bytes = 1 },
        ...
        0xff => Instruction{ .opcode = 0xff, .op = OpType.RST, .operands = .{ Operand{ .t=OperandType.vec, .relative = false }, Operand{ .t=OperandType.unused, .relative = false }, Operand{ .t=OperandType.unused, .relative = false } }, .num_operands = 1, .bytes = 1 },
    };
    return result;
}
